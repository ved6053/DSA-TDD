...
public class QuickUnionAndFastFindRankedBySizeDisjointSetTest {
  ...
  void initialize() {
    ...
    disjointSet = new QuickUnionAndFastFindRankedBySizeDisjointSet(setArray);
  }
  ...
  void union() {
    try {
      ...
      assertEquals(9, disjointSet.find(3));
    } catch (NoSuchObjectException ex) {
      fail(ex.getMessage());
    }
  }
