...
class DecodeWaysTest {
  ...
  class Recursion {
    ...
    /**
     * Input: s = "226" Output: 3 Explanation: "226" could be decoded as "BZ" (2 26), "VF" (22 6),
     * or "BBF" (2 2 6).
     */
    @Test
    ...
    @Test
    /**
     * Input: s = "06" Output: 0 Explanation: "06" cannot be mapped to "F" because of the leading
