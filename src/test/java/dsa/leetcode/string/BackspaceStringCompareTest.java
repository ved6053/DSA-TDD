...
class BackspaceStringCompareTest {
  ...
  /**
   * Input: s = "nzp#om##g", t = "b#nzp#op##g" Output: true Explanation: s becomes "nzg" while t
   * becomes "nzg".
   */
  @Test
  void whenTestCase4_then_callBackspaceStringCompare() {
    String s = "nzp#om##g", t = "ab##nzp#op##g";
    assertTrue(backspaceStringCompare.backspaceCompare(s, t));
  }
}
